...
describe("DiContainer", function () {
    ...
    it('bootstrapped properly', function () {
        chai_2.expect(bootstrapped).to.be.equal(true);
    });
    describe("DiContainer.getNthContainer(1)", function () {
        it('should return an instance of DiContainer set at bootstrap', function () {
            ...
            new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
            chai_2.expect(DiContainer_1.default.getNthContainer(1)).to.be.equal(DiContainer_1.default.getFirstContainer()).and.to.be.equal(a);
        });
    });
    describe("DiContainer.getLatestContainer()", function () {
        it('should return an instance of DiContainer set at bootstrap', function () {
            var d = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
            chai_2.expect(DiContainer_1.default.getLatestContainer())
    ...
    describe("DiContainer.mergeObjects(a, b)", function () {
        it('should return an object with both merged (no collision)', function () {
            ...
            chai_2.expect(di.mergeObjects(o1, o2)).to.be.deep.equal(expected);
        });
    });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            chai_2.expect(di.has('HelloAddedAfterwards')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('HelloAddedAfterwards')).to.be.equal(true);
                            return [2 /*return*/];
                    }
                });
            });
    ...
    describe("di.loadAll()", function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('Hello')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('Hello')).to.be.equal(true);
                            return [2 /*return*/];
                    }
                });
            });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('data')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('data')).to.be.equal(true);
                            chai_2.expect(afterWasExecuted).to.be.equal(true);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            chai_2.expect(di.has('WillBeReplaced')).to.be.equal(true);
                            _a = chai_2.expect;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('emptyObject')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                        ...
                        case 2:
                            eo = _a.sent();
                            chai_2.expect(eo).to.be.equal(data);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('HelloStaticInjectable')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('HelloStaticInjectable')).to.be.equal(true);
                            chai_2.expect(Hello.getInjection().d).to.be.equal('d');
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('HelloConstructible')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('HelloConstructible')).to.be.equal(true);
                            return [4 /*yield*/, di.get('HelloConstructible')];
                        case 2:
                            e = (_a.sent()).injection.e;
                            chai_2.expect(e).to.be.equal('e');
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                            chai_2.expect(di.has('HelloObjDestructurableParams')).to.be.equal(false);
                            return [4 /*yield*/, di.loadAll()];
                        case 1:
                            _a.sent();
                            chai_2.expect(di.has('HelloObjDestructurableParams')).to.be.equal(true);
                            return [4 /*yield*/, di.get('HelloObjDestructurableParams')];
                        case 2:
                            aaa = _a.sent();
                            chai_2.expect(aaa.param1).to.be.equal(data2.a);
                            chai_2.expect(aaa.param2).to.be.equal(data2.b);
                            return [2 /*return*/];
                    }
                });
            });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            dep = _a.sent();
                            chai_2.expect(aaa.injection).to.be.deep.equal({
                                some: {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            aaa = _a.sent();
                            chai_2.expect(typeof aaa.injection).to.not.be.equal('undefined');
                            chai_2.expect(typeof aaa.injection.additionFromBefore).to.not.be.equal('undefined');
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should return true on subsequent calls to loadAll()', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    di = new DiContainer_1.default({ logger: saylo_1.logger, load: injectionDict });
                    chai_2.expect(di.loadAll()).to.eventually.be.equal(false);
                    chai_2.expect(di.loadAll()).to.eventually.be.equal(true);
                    chai_2.expect(di.loadAll()).to.eventually.be.equal(true);
                    return [2 /*return*/];
                });
            });
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            key = 'data';
                            chai_2.expect(di.has(key)).to.be.equal(true);
                            value = 'new value';
                            di.set(key, value);
                            _a = chai_2.expect;
                            return [4 /*yield*/, di.get(key)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            hey = _a.sent();
                            chai_2.expect(hey.hoya).to.be.deep.equal([param1, param2]);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should throw if listener is not a function', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    param1 = { hey: 'hoy' };
                    param2 = { hey2: 'hoy2' };
                    chai_2.expect(di.emit('onHoyEvent', param1, param2)).to.eventually.throw();
                    return [2 /*return*/];
                });
            });
        });
